...
exports.verifyPasskey = async (request, response) => {
    ...
    try {
        ...
        try {
            ...
            user.webauthnid = verifiedRegistration.credential.id; 
            user.webauthnpublickey = verifiedRegistration.credential.publicKey; 
            console.log('user challenge:', user.challenge);
            user.challenge = null; 
            await user.save();

            // user challenge: 1vYIQ6fdMw2W3Cm2z084eB4D6lNPfEdCesjk57WMwJU=
            // challenge:     '1vYIQ6fdMw2W3Cm2z084eB4D6lNPfEdCesjk57WMwJU'
            ...
            response.json({
                ...
                user: {
                    ...
                    name: user.username,
                    email: user.email, 
                    hasRegisteredPasskey: !!user.webauthnid,  
                },
                credential: verifiedRegistration.credential,
                authenticator: verifiedRegistration.authenticator 
            });
